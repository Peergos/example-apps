 ...
 * Original file: /npm/@editorjs/image@2.8.2/dist/bundle.js
 *
    ...
    , function(e, t, n) {
        ...
        , function(e, t, n) {
            ...
            ,
            {
                ...
                selectFiles: function(e, preview) {
                    return delete (e = u(e)).beforeSend,
                    d.selectFiles(e, preview)
                }
            });
            e.exports = f
        }
      							...
      							if (response.status === 200) {
									response.arrayBuffer().then(function(buffer) {
										...
										if (file.length > 0) {
											...
											fetch(currentFolder + file + '?preview=true', { method: 'GET' }).then(function(response) {
    											if (response.status === 200) {
													response.arrayBuffer().then(function(buffer) {
														let text = new TextDecoder().decode(buffer);										
														previewFunc(text);
            ...
            return l()(e, [{
                ...
                value: function(t) {
                    var n = this
                      ...
                      , o = {
                        src: t.startsWith("data:") ? t : getCurrentFolder() + t
                    }
                      , i = "load";
